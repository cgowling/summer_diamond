...
class Example(QWidget):
    ...
    def initUI(self):# constructor
        ...
        def createTextBox(self,label,labelName, labelNameEdit, position,):
...
#            self.menu.currentIndexChanged.connect(self.preProcessSelection)
        ...
        createTextBox(self,"Plugin template name:", "modName","modNameEdit",1)     
#        self.modNameEdit.setToolTip('Input the name of the module you want to create. It must be of the form: plugin_template.py, i.e all lowercase and underscores instead of spaces with .py at the end')
        ...
        createTextBox(self,"Your name:","userName","userNameEdit",2)
        
        createTextBox(self,"Your e-mail:","Email","emailEdit",3 )
      
        createDropdown("Pre-processing:","prepLabel","prep",4)
        
        createTextBox(self,"Filter frames:","filterFrameNo","filterFrameNoEdit",5)
         
        createDropdown("Post-processing:","postpLabel","postp",6)
        
        createTextBox(self,"Number of input data sets:","inputNo","inputNoEdit",7)

        createTextBox(self,"Number of output data sets:","outputNo","outputNoEdit",8)
